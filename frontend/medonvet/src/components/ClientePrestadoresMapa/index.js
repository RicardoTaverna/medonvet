...
import { loadGoogleMaps, removeGoogleMaps } from '../../services/googleMaps';

export class ClientePrestadoresMapa extends Component {
...
export default ClientePrestadoresMapa;