...
def consumer(queue):
    ...
    while True:
        ...
        if method_frame:
            ...
            sg = sendgrid.SendGridAPIClient(api_key="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")
            from_email = Email("suporte.medonvet@proton.me")  # Change to your verified sender
